...
export type AppEnv = {
  ...
  ACCESS_CONTROL_CONTRACT_ADDRESS?: string;
  PLANNING_REGISTRY_CONTRACT_ADDRESS?: string;
...
export function validateEnv(rawEnv: RawEnv): AppEnv {
  ...
  const env: AppEnv = {
    ...
    RECEIPT_CONTRACT_ADDRESS: getString(rawEnv, 'RECEIPT_CONTRACT_ADDRESS'),
    ACCESS_CONTROL_CONTRACT_ADDRESS: getString(rawEnv, 'ACCESS_CONTROL_CONTRACT_ADDRESS'),
    PLANNING_REGISTRY_CONTRACT_ADDRESS: getString(rawEnv, 'PLANNING_REGISTRY_CONTRACT_ADDRESS'),
