...
const services = [
  { id: 'chuyen-nhuong', title: 'Đăng ký Chuyển nhượng', desc: 'Mua bán / Tặng cho - Thay đổi chủ sở hữu thửa đất hiện tại.', days: 15, icon: <SwapOutlined />, dev: true },
  { id: 'the-chap', title: 'Đăng ký Thế chấp', desc: 'Vay vốn ngân hàng hoặc xóa thế chấp (Giải chấp) tài sản.', days: 3, icon: <BankOutlined />, dev: true },
  { id: 'cap-doi', title: 'Cấp đổi / Cấp lại GCN', desc: 'Sổ cũ rách, nhòe hoặc bị mất cần cấp lại giấy chứng nhận mới.', days: 7, icon: <FileTextOutlined />, dev: true },
  { id: 'tach-thua', title: 'Tách thửa / Hợp thửa', desc: 'Chia nhỏ thửa đất hiện tại hoặc gộp nhiều mảnh đất kề nhau.', days: 15, icon: <SplitCellsOutlined />, dev: true },
  { id: 'tai-len', title: 'Tải lên tài sản số', desc: 'Chuyển loại đất (ví dụ: đất nông nghiệp sang đất ở đô thị) và số hóa quyền sở hữu lên nền tảng Blockchain.', days: 20, icon: <CloudUploadOutlined />, dev: false },
  { id: 'thua-ke', title: 'Khai nhận Thừa kế', desc: 'Cập nhật chủ sở hữu mới theo di chúc hoặc quy định pháp luật.', days: 15, icon: <BranchesOutlined />, dev: true },
];
    ...
    <div className="animate-fade-in">
      ...
      <div className="flex items-center gap-3 mb-8 text-sm">
        ...
        {['Chuyển nhượng', 'Thế chấp', 'Tách thửa', 'Cấp đổi'].map(tag => (
          <span key={tag} className="bg-gray-100 text-gray-700 px-4 py-1.5 rounded-full cursor-pointer hover:bg-gray-200 transition-colors font-medium">
            {tag}
          </span>
        ))}
      </div>
      ...
      <div className="flex gap-8 border-b border-gray-200 mb-8 text-sm font-medium">
        <div className="pb-3 border-b-2 border-[#0c56d0] text-[#0c56d0] cursor-pointer">Tất cả</div>
        <div className="pb-3 text-gray-500 hover:text-gray-900 cursor-pointer transition-colors">Chuyển quyền & Biến động</div>
        <div className="pb-3 text-gray-500 hover:text-gray-900 cursor-pointer transition-colors">Cấp mới & Cấp đổi</div>
        <div className="pb-3 text-gray-500 hover:text-gray-900 cursor-pointer transition-colors">Tài chính & Thế chấp</div>
      </div>
